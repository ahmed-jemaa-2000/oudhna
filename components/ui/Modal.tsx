...
export const Modal: React.FC<ModalProps> = ({ isOpen, onClose, children, title }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-md p-4">
      <div className="bg-app-surface border border-app-border rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-auto relative animate-fade-in shadow-2xl shadow-brand-orange/10">
